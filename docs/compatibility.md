...
`0.2.0-mvp.1`. Build the runtime from the current managed-state version 2 source and keep the
...
| Installed Symphony binary | `0.2.0-mvp.1` | Required local MVP executable; installation and delivery evidence remain to be collected |
...
`0.2.0-mvp.1` executable and managed-state version 2. Do not launch synthetic
...
`0.2.0-mvp.1` executable from current managed-state version 2 source, then retain the
