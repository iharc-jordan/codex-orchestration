---
name: setup
description: Install and operate the Windows-only Symphony runtime packaged with Codex Orchestration.
---
...
binding values and provider settings:
    ...
    node "$plugin\mcp\cli.mjs" setup --release-manifest $manifest --workflow $workflow --version 0.5.0
...
published manifest (or an independently verified release receipt):
    ...
    node .\mcp\cli.mjs setup --executable C:\path\symphony-windows.zip --sha256 <64-hex-digest> --workflow C:\path\WORKFLOW.md --version 0.5.0
